...
Genera:
    ...
    - .data/processed_data/A_base/pairs_windows.csv (Step 3)
    - .data/processed_data/A_base/donors_per_victim.csv (Step 3)
    - .data/processed_data/A_base/episodes_index.parquet (Step 3)
"""
...
def main():
    ...
    try:
        ...
        outputs_to_check = [
            ...
            (".data/processed_data/A_base/pairs_windows.csv", "Step 3: pairs_windows.csv"),
            (".data/processed_data/A_base/donors_per_victim.csv", "Step 3: donors_per_victim.csv"),
            (".data/processed_data/A_base/episodes_index.parquet", "Step 3: episodes_index.parquet"),
        ]
        ...
        if all_exist:
            ...
            print("      python -c \"import pandas as pd; df = pd.read_parquet('.data/processed_data/A_base/episodes_index.parquet'); print(f'Episodios: {len(df)}')\"")
            print()
            print("   2. Ejecutar experimentos (usarán este dataset base):")
